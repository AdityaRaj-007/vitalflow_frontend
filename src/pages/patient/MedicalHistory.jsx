...
const CONDITIONS = [
  { name: 'Type 2 Diabetes',      since: '2019', status: 'managed',    doctor: 'Dr. Webb'  },
  { name: 'Hypertension Stage 1', since: '2021', status: 'monitoring', doctor: 'Dr. Chen'  },
  { name: 'Vitamin D Deficiency', since: '2023', status: 'resolved',   doctor: 'Dr. Patel' },
]

const MEDICATIONS = [
  { name: 'Metformin 500mg',    freq: 'Twice daily', start: 'Jan 2019', refill: 'Mar 5, 2026'  },
  { name: 'Lisinopril 10mg',   freq: 'Once daily',  start: 'Aug 2021', refill: 'Apr 1, 2026'  },
  { name: 'Vitamin D3 2000IU', freq: 'Once daily',  start: 'Dec 2023', refill: 'Mar 20, 2026' },
]

const TIMELINE = [
  { date: 'Jan 15, 2026', event: 'Blood Panel — All markers within normal range', type: 'lab'          },
  { date: 'Dec 28, 2025', event: 'ECG — Normal sinus rhythm',                     type: 'imaging'      },
  { date: 'Oct 10, 2025', event: 'Annual Physical — BP 122/80',                   type: 'visit'        },
  { date: 'Aug 5, 2025',  event: 'Prescription renewal — Metformin',              type: 'prescription' },
]
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-slate">Since {c.since} · {c.doctor}</p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 animate-fade-in">
          {MEDICATIONS.map((m, i) => (
            <Card key={i}>
              ...
              <p className="text-xs text-slate mb-4">{m.freq} · Started {m.start}</p>
          ...
          {TIMELINE.map((item, i) => (
            <div key={i} className="relative mb-5 sm:mb-6">
              ...
              <Card className="!p-3.5 sm:!p-4">
                <p className="text-[11px] text-slate mb-1.5">{item.date}</p>
